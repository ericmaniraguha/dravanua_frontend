...
import {
  ...
  Calendar, Clock, MessageSquare, DollarSign, Megaphone, Cloud, CreditCard, BellRing, QrCode, Landmark
} from 'lucide-react';
...
const Sidebar = ({ onLogout, user, isOpen }) => {
  ...
  const menuItems = [
    ...
    { icon: <Cloud size={18} />, label: 'Dropbox Vault', path: '/admin/vault', color: '#0ea5e9' }, // Sky Blue
    ...
    { icon: <DollarSign size={18} />, label: 'Payroll Intelligence', path: '/admin/payroll', color: '#1B5E20' },
