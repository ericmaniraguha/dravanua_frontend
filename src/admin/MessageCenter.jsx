...
<div style="font-family: 'Inter', Arial, sans-serif; max-width: 700px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 25px rgba(0,0,0,0.05);">
  ...
  <div style="padding: 40px 35px; line-height: 1.7; color: #1e293b;">
    <h2 style="color: #32FC05; margin-top: 0; font-size: 20px; font-weight: 800;">${composeData.subject}</h2>

    <div style="margin: 25px 0; font-size: 16px; color: #334155;">
      ${composeData.body.replace(/\n/g, '<br/>')}
    </div>

    <div style="background: #f8fafc; padding: 20px; border-radius: 12px; border-left: 4px solid #32FC05; margin-top: 30px;">
    ...
    <p style="margin-top: 40px; border-top: 1px solid #f1f5f9; padding-top: 25px; font-size: 15px; color: #64748b;">
      Best regards,<br/>
      <strong style="color: #32FC05;">Dravanua Hub Operations</strong>
    </p>
  </div>
    ...
    <div className="admin-page animate-fadeIn">
              ...
              {['all', 'pending', 'replied'].map(f => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: '1px solid',
                    background: inboxFilter === f ? '#32FC05' : '#f8fafc',
                    color: inboxFilter === f ? 'white' : '#64748b',
                    fontSize: '0.7rem',
                    fontWeight: 800,
                    cursor: 'pointer',
                    borderColor: inboxFilter === f ? '#32FC05' : '#e2e8f0'
                  }}
                >
                  {f.toUpperCase()}
                </button>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
            <button
              ...
              style={{
                ...
                cursor: 'pointer', fontSize: '0.75rem', fontWeight: 800, color: '#32FC05', display: 'flex', alignItems: 'center', gap: '6px'
              }}
            >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '340px 1fr', gap: '1.5rem', height: 'calc(100vh - 320px)' }}>
        ...
        <div style={{ padding: 0, overflow: 'hidden', border: '1px solid #e2e8f0', borderRadius: '16px', background: 'white', display: 'flex', flexDirection: 'column' }}>
          <div style={{ background: 'linear-gradient(135deg, #0D3B0D, #32FC05)', padding: '12px 20px' }}>
            ...
            {filteredMessages.length === 0 ? (
              ...
              <div
                ...
                style={{
                  ...
                  gap: '12px',
                  transition: 'all 0.2s',
                  borderLeft: activeMessage?.id === msg.id ? '4px solid #32FC05' : '4px solid transparent'
                }}
                className="hover-row"
              >
                <div
                  style={{
                    ...
                    height: '40px',
                    borderRadius: '12px',
                    background: msg.senderName === 'SYSTEM BROADCAST' ? '#64748b' : 'linear-gradient(135deg, #32FC05, #32CD32)',
                    color: 'white',
                    display: 'flex',
                    alignItems: 'center',
          ...
          {activeMessage ? (
            <>
              ...
              <div style={{ padding: '0.75rem 1.5rem', background: '#f8fafc', borderBottom: '1px solid #f1f5f9', display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                <button onClick={() => toggleStatus(activeMessage.id, 'replied')} className="btn btn-primary" style={{ padding: '6px 12px', fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: '4px', background: activeMessage.status === 'replied' ? '#dcfce7' : '#32FC05', color: activeMessage.status === 'replied' ? '#166534' : 'white', border: 'none', borderRadius: '8px', fontWeight: 800, cursor: 'pointer' }}>
                ...
                <button onClick={() => handleEditContent(activeMessage.id, activeMessage.content)} className="btn btn-outline" style={{ padding: '6px 12px', fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: '4px', background: '#f8fafc', color: '#32FC05', border: '1px solid #e2e8f0', borderRadius: '8px', fontWeight: 800, cursor: 'pointer' }}>
              ...
              <div style={{ flex: 1, padding: '2rem', overflowY: 'auto', background: '#f8fafc' }}>
                ...
                {activeMessage.replyContent && (
                  <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <div style={{ background: '#32FC05', color: 'white', padding: '1.5rem', borderRadius: '12px', maxWidth: '80%', lineHeight: '1.6', whiteSpace: 'pre-wrap', wordWrap: 'break-word' }}>
                      {activeMessage.replyContent}
                    </div>
                  </div>
                )}
